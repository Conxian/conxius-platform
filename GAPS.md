...
- **Implemented & Audited**:
  - **Kwil Transactional State**: Full migration from Neon to Kwil for Nexus state history (`/api/v1/kwil/info`).
  ...
  - **Universal Bitcoin Identity (UBI)**: DID-linked sovereign identity management (`/api/v1/identity/ubi`).
