...
- [x] **[R-7-06]** Add fail-closed verifier/payment contracts, pre-parse canonical attestation payload limits, bounded BitVM3 terminal retention, async lifecycle/replay protection, ZKCP retention/pagination, atomic signer reservations, bounded identifier logging, and contamination guards (Issue #1187); backend enablement remains a separate gate.
