...
| **G-50** | **ZK Contingent Payments** | 10 | 9 | 7 | **26** | [ZKCP Research](./architecture/FULL_STACK_BITCOIN_RESEARCH.md#50) — verifier/observer and external durable key-release backends pending; lookup/idempotency contract is fail-closed |
