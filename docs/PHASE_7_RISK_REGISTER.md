...
- [x] **[R-7-06]** Add fail-closed verifier/payment contracts, bounded resource limits, async lifecycle race protection, atomic signer reservations, and contamination guards (Issue #1187); backend enablement remains a separate gate.
